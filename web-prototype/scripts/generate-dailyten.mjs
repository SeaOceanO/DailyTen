  ...
  const response = await fetchWithContext('https://api.openai.com/v1/responses', {
    ...
    body: JSON.stringify({
      ...
      instructions: [
        ...
        'Write like a sharp human editor, not like a wire-service rewrite. The reader should feel: now I know why this matters.',
        'Every selected story needs an editorial angle: what is surprising, costly, risky, useful, unfair, delayed, disputed, or likely to change behavior.',
        'Do not merely restate the source title. Reframe the event around the concrete consequence for people, work, money, products, safety, privacy, or daily decisions.',
        'Titles should create a reason to open the card. They can be direct, slightly curious, or tension-driven, but never clickbait and never vague.',
        'Use the rhythm of a real person explaining the news over coffee: short, clear, specific, and a little alive. It can sound curious or mildly sharp, but it must stay accurate.',
        'Avoid textbook structure. Do not write every story as “某方表示……这意味着……将影响……”. Vary the sentence shape.',
        'Do not hide the interesting part behind institutional wording. If the real story is “prices may rise”, “an app may become harder to use”, “a country is drawing a red line”, or “a company is trying to control the entry point”, say that plainly.',
        'Each item must have a brief field: one plain, compact sentence for the collapsed card.',
        'brief is for scanning; take is for the expanded explanation. The collapsed card must read like one everyday sentence that gives the useful point immediately, not an official summary, policy abstract, or industry report sentence.',
        'A good brief should answer: why should I care in five seconds? A bad brief only says that something was announced, promoted, expanded, strengthened, accelerated, or upgraded.',
        'take should feel like a concise explanation from a knowledgeable friend: what happened, what changes, who is affected, what is still uncertain.',
        ...
        'Avoid vague phrases such as 加速落地, 赋能, 释放价值, 稳中向好, 生态完善, 深化合作, 引发关注, 迎来升级, 释放信号 unless you immediately explain what that means in concrete terms.',
        'Prefer verbs people can picture: 涨价, 延迟, 限制, 开放, 下架, 裁员, 投产, 断供, 审查, 赔付, 改规则, 抢入口, 降门槛.',
        ...
        'For English output, avoid corporate words like leverage, accelerate, ecosystem, unlock value, robust, strategic unless they are part of a quoted name.',
      ...
      input: JSON.stringify({
        ...
        outputNotes: [
          ...
          'title should contain the story angle, not just the event. Bad: 某公司发布新模型. Good: 新模型开始替人操作电脑，安全边界成了真正问题.',
          ...
          'brief should not begin with empty setup phrases such as “这意味着”, “该事件显示”, “业内认为”, or “值得关注的是”. Start with the concrete point.',
          'brief should sound like a human summary, not a report caption. Bad: “欧洲安全紧张感进一步上升.” Good: “欧洲不是马上开打，但正在把俄罗斯风险看得更近了.”',
          'take should be one readable paragraph in everyday language, while preserving the important numbers and consequences.',
          'take should add explanation beyond brief; it must not be the same sentence stretched longer.',
          'take may use one light human phrase when useful, but it must not become jokes, slang, or emotional ranting.',
